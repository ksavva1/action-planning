...
psychological assumptions about which information should drive reach, grasp, rotate,
...
# Baseline matrix
# Relational rows strongly drive translate and rotate because they represent
# the gap between current object pose and target pose.
...
def get_affordance_matrix(variant: str) -> np.ndarray:
    """Return the matrix for a named variant or raise error."""
