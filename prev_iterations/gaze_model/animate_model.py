...
All stage presets and task configurations must be supplied by the caller.
Import animate() from a notebook and pass DevelopmentalParams and TaskConfig
objects explicitly.
"""
...
from prev_iterations.gaze_model.model_utils import DevelopmentalParams, TaskConfig
